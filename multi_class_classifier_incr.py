...
for num_examples in range(1000, 7000, 1000):
    ...
    for fold in range(2):
        ...
        for iteration in range(TRAINING_ITERATIONS):
            ...
            print iteration, learning_mistakes
    ...
    testing_accuracy_per_increment.append(float(sum(testing_accuracy_list)/len(testing_accuracy_list)))

print testing_accuracy_per_increment
plt.plot(range(1000, 7000, 1000), testing_accuracy_per_fold)
plt.ylabel('Accuracy')
